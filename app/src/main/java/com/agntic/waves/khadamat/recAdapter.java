...
public class recAdapter extends RecyclerView.Adapter<recAdapter.ViewHolder> {
    ...
    public static List<RecModels> mobiles = new ArrayList<>();

    public recAdapter(Context context, List<RecModels> mobiles) {
    ...
    public recAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final recAdapter.ViewHolder viewHolder = new recAdapter.ViewHolder(cardView);
        ...
        if (mobiles.get(0).getUrl_img() != null) {
            ...
            //        .apply(options).into(Returant.imageView2);
            Glide.with(context)
                    .load(mobiles.get(0).getUrl_img())
                    .thumbnail( 0.5f )
                    .apply(options)
                    .into(Returant.imageView2);
