...
public class Coffe extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(
                new LinearLayoutManager(Coffe.this, LinearLayoutManager.VERTICAL,
                        false));
        videolist();
    ...
    public void videolist() {
        try {
            ...
            String url = "http://" + IPserver + "/Amvaj/service/caffe/json.php";
            //String url = "http://188.158.121.78/Amvaj/service/caffe/json.php";
...
// Start the queue
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        List<CofModels> oneplusMobiles = new ArrayList<CofModels>();
                        ...
                        for (int i = 0; i < students.length(); i++) {
                            JSONObject c = students.getJSONObject(i);
                                    ...
                                    oneplusMobiles.add(new CofModels(name, imgUrl));
                                }
                        ...
                        adapter = new caffeAdapter(Coffe.this,oneplusMobiles);
    ...
    public void onBackPressed() {
        ...
        Intent uou = new Intent(Coffe.this, khadamat.class);
        startActivity(uou);
        Coffe.this.finish();
